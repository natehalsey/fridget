...
/**
 * Rreturns a div with two accordions, one with a list of ingredients and the other with a list of recipes
...
const MyFridget = () => {
  ...
  const getRecipesByFridget = () => {
    loadQuery(API_URL + getRecipeByIngredientURL, {
      [searchParamIngredient]: checked.join(),
    })
      .then((response) => {
