          ...
          <div className="col-xs-12 col-sm-7 ">
            ...
            <ul className="list-group d-flex justify-content-start">
              <li className="list-group-item list-group-item-primary">
                ...
                encouraging users to cook what's in their fridge. So don't eat
                out tonight, fridget instead. Or, use our platform to share
                recipes with your friends and family, easily and seamlessly.
              </li>
            </ul>
          </div>
          ...
          <div className="col-xs-12 col-sm-7">
            ...
            <ul className="list-group d-flex justify-content-start ">
              <li className="list-group-item list-group-item-secondary">
                ...
                individuals to easily share and manage their recipes, manage
                their fridge ingredients, and find recipes they can make right
                now -- with just the items in their fridge.
              </li>
            </ul>
          </div>
        </div>
